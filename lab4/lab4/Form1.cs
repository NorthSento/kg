...
namespace Lab5
{
    public class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.DoubleBuffered = true; // Для устранения мерцания при перерисовке

            cube = new Cube();

            this.Paint += OnPaint;
            this.KeyDown += OnKeyDown;
            this.KeyPreview = true; // Обеспечивает перехват событий клавиатуры
        }
        ...
        private void OnKeyDown(object sender, KeyEventArgs e)
        {
            ...
            this.Invalidate(); // Обновляем окно для перерисовки
        }
    ...
    public class Cube
    {
        ...
        private Point Project(Point3D point, int centerX, int centerY)
        {
            ...
            return new Point(
                ...
                (int)(centerY - point.Y * scale) // Инвертируем Y для экранных координат
            );
        }
    }
